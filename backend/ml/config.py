...
DATA_DIRS = {
    ...
    "geospatial": PROJECT_ROOT / "backend" / "data" / "geospatial",
    "sentinel": PROJECT_ROOT / "backend" / "data" / "sentinel",
    "fixtures": PROJECT_ROOT / "backend" / "data" / "fixtures",
}
...
DATA_SOURCES = {
    ...
    # Biodiversity data
    "biodiversity_points": {
        "path": DATA_DIRS["data_root"] / "biodiversity" / "biodiversity_points.csv",
        "format": "csv",
        "description": "Species occurrence points from GBIF",
        "source": "GBIF (Global Biodiversity Information Facility)",
        "license": "CC-BY 4.0",
        "required_fields": ["id", "lat", "lon", "scientific_name", "local_name", "source"]
    },
    "species_local_names": {
        "path": DATA_DIRS["data_root"] / "biodiversity" / "species_local_names.csv",
        "format": "csv",
        "description": "Scientific to local name mapping",
        "source": "KEFRI + academic sources",
        "license": "Fair use (citation required)",
        "required_fields": ["scientific_name", "local_name"]
    },
...
API_ENDPOINTS = {
    ...
    "nasa_power": {
        "base_url": "https://power.larc.nasa.gov/api/v1/",
        "endpoints": {
    ...
    "soilgrids": {
        "base_url": "https://rest.soilgrids.org/soilgrids/v2.0/",
        "endpoints": {
